package com.hebertfreitas.cursomc;
...
import com.hebertfreitas.cursomc.domain.Pagamento;
import com.hebertfreitas.cursomc.domain.PagamentoComBoleto;
import com.hebertfreitas.cursomc.domain.PagamentoComCartao;
...
import com.hebertfreitas.cursomc.repositories.CidadeRepository;
...
import com.hebertfreitas.cursomc.repositories.EstadoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Pagamento pgto2 = new PagamentoComBoleto(null, EstadoPagamento.PEENDENTE, ped2, sdf.parse("20/10/2017 00:00"), null);
